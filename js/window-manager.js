...
class NexusWindowManager {
    ...
    createWindow(options = {}) {
        ...
        /*
         * Only one popup/window should be open at a time.
         * If a window with the same application already exists,
         * close other open windows and focus/restore it.
         */
        ...
        if (
            ...
            if (existing) {
                ...
                this.windows.forEach((win, winId) => {
                    if (win && win.id !== existing.id && !win.closed) {
        ...
        /*
         * Close all currently open windows before opening the new one.
         */
        this.windows.forEach((win, winId) => {
            if (win && !win.closed) {
                this.closeWindow(winId);
        ...
        if (titlebar) {
            ...
            titlebar.addEventListener(
                ...
                (event) => {
                     ...
                     * window control or cancel buttons.
                     */
